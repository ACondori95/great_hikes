// The controller nedds access to both the model and the view... so let's import them
...
export default class HikesController {
  ...
  // in order to show the details of a hike ontouched we will need to attach a listener AFTER the list of hikes has been built. The function below does that.
  addHikeListener() {
